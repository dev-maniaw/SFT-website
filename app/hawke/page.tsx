...
/* ═══════════════════════════════════════════════════════════════════
   SECTION DATA — HAWKE 10 Chapters
═══════════════════════════════════════════════════════════════════ */
const SECTIONS = [
  {
    ...
    chips: [
      ...
      { val: '24–72 HR', lbl: 'Persist' },
      { val: '20 KG', lbl: 'Payload' },
      { val: '5 KM', lbl: 'Coverage' },
    ],
    pos: 'center' as const,
    bgPos: 'center center',
    img: '/sft/hawke/Hawke - What Hawke Delivers.jpeg',
  ...
  },
  {
    ...
    note: '',
    chips: [
      { val: '🔥', lbl: 'Disaster Response' },
      { val: '🛡', lbl: 'Defence & Security' },
      { val: '⛏', lbl: 'Mining & Industry' },
      { val: '🌿', lbl: 'Environment' },
    ],
    pos: 'right' as const,
    bgPos: 'left center',
  ...
  },
  {
    ...
    pos: 'left' as const,
    bgPos: 'right center',
    img: '/sft/hawke/Hawke - System Architecture.jpeg',
  ...
  },
  {
    ...
    pos: 'right' as const,
    bgPos: 'left center',
    img: '/sft/hawke/Hawke - Deployment Flow.jpeg',
    overlay: 'linear-gradient(270deg, rgba(5,5,5,0.94) 0%, rgba(5,5,5,0.82) 38%, rgba(5,5,5,0.3) 65%, transparent 100%)',
  ...
  },
  {
    ...
    pos: 'left' as const,
    bgPos: 'right center',
    img: '/sft/hawke/Hawke - Competitive Advatages.jpeg',
    overlay: 'linear-gradient(90deg, rgba(5,5,5,0.94) 0%, rgba(5,5,5,0.82) 38%, rgba(5,5,5,0.3) 65%, transparent 100%)',
  ...
  },
  {
    ...
    pos: 'center' as const,
    bgPos: 'center center',
    img: '/sft/hawke/Hawke - Tecnology Rediness.jpeg',
    overlay: 'radial-gradient(ellipse at center, rgba(5,5,5,0.84) 0%, rgba(5,5,5,0.62) 40%, rgba(5,5,5,0.25) 65%, transparent 100%)',
...
.bg-layer{position:fixed;inset:0;z-index:1;background-size:cover;background-position:center;will-change:transform,opacity;transition:opacity 0.6s cubic-bezier(.16,1,.3,1)}
.bg-overlay{position:fixed;inset:0;z-index:1;transition:opacity 0.6s cubic-bezier(.16,1,.3,1)}
        ...
        <div className="m-stories">
          ...
          <div className={`m-slide${activeStory === N ? ' active' : ''}`}>
            ...
            <div className="m-outro-content">
              ...
              <h2 className="m-outro-title">Deploy<br /><span className="oc">Connectivity</span><br />When It Matters</h2>
              <p className="m-outro-sub">Ready to explore HAWKE for your mission? Let&apos;s talk.</p>
    ...
    <><style dangerouslySetInnerHTML={{ __html: CSS }} />
      ...
      <nav className="s-nav">
        ...
        <div className="s-nav-right">
          <a href="/" className="s-nav-link">Home</a><a href="/about" className="s-nav-link">About</a><a href="/mobius" className="s-nav-link">MOBIUS</a><a href="/applications" className="s-nav-link">Applications</a><a href="/ecosystem" className="s-nav-link">Ecosystem</a><a href="tel:+919486675847" className="s-cta-btn">Request Pilot</a>
        </div>
      ...
      <div ref={introRef} className="intro-panel vis">
        <div className="i-eye"><span className="i-eye-line" />HAWKE<span className="i-eye-line" /></div>
        <h1 className="i-title">RAPIDLY<br />DEPLOYABLE<br /><span className="gc">AERIAL PLATFORM</span></h1>
        <p className="i-sub">Tethered aerial system for communication relay, surveillance, and mission-grade payload operations.</p>
