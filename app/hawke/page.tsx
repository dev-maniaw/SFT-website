...
.bg-layer{position:fixed;inset:-5%;z-index:1;width:110%;height:110%;background-size:cover;background-position:center;will-change:transform,opacity;transition:opacity 0.6s cubic-bezier(.16,1,.3,1)}
