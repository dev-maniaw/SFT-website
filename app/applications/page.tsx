...
const SECTIONS: {
  ...
  },
  {
    ...
    cta: [],
    environments: [
      { label: 'DISASTER ZONES', icon: '🚨' },
      { label: 'BORDER REGIONS', icon: '🛡️' },
      { label: 'INDUSTRIAL SITES', icon: '⛏️' },
      { label: 'FOREST & TERRAIN', icon: '🌿' },
    ],
  },
  {
  ...
  },
  {
    ...
    cta: [],
    payloads: [
      { title: 'COMMUNICATION', desc: 'Network relay modules for voice, data, and signal extension', icon: '📡' },
      { title: 'OPTICAL', desc: 'EO cameras for high-resolution visual monitoring', icon: '📷' },
      { title: 'THERMAL', desc: 'Infrared sensors for night and low-visibility environments', icon: '🌡️' },
      { title: 'RADAR', desc: 'Detection and tracking for aerial and ground threats', icon: '📊' },
      { title: 'ENVIRONMENTAL', desc: 'Air quality, terrain, and ecosystem monitoring', icon: '🌍' },
    ],
  },
  {
  ...
  },
  {
    ...
    cta: [],
    scenarios: [
      { title: 'DISASTER ZONES', desc: 'Rapid deployment in post-disaster environments for immediate communication restoration', icon: '🚨' },
      { title: 'BORDER REGIONS', desc: 'Persistent monitoring across remote and challenging border terrains', icon: '🛡️' },
      { title: 'REMOTE TERRAINS', desc: 'Connectivity and monitoring in areas without existing infrastructure', icon: '🏔️' },
      { title: 'INDUSTRIAL SITES', desc: 'Continuous oversight for mining, construction, and energy operations', icon: '⛏️' },
      { title: 'TEMPORARY OPS', desc: 'Event-based and time-limited deployments with rapid setup and teardown', icon: '⏱️' },
    ],
  },
  {
...
.env-tag-label{
  font-family:'Space Grotesk',sans-serif;
  font-size:0.75rem;font-weight:600;letter-spacing:.18em;text-transform:uppercase;
...
.app-pillar-heading{
  ...
  color:rgba(74,199,255,0.6);margin-bottom:8px;line-height:1.4;
}
.app-pillar-body{
  font-family:'Inter',sans-serif;
  font-size:0.78rem;color:rgba(167,175,187,0.75);line-height:1.6;
  margin-bottom:10px;
}
.app-pillar-caps{
...
.app-pillar-cap{
  font-family:'Space Grotesk',sans-serif;
  font-size:0.6rem;font-weight:500;letter-spacing:.1em;text-transform:uppercase;
  color:rgba(74,199,255,0.5);
  background:rgba(74,199,255,0.05);
...
.scenario-desc{
  font-family:'Inter',sans-serif;
  font-size:0.72rem;color:rgba(167,175,187,0.65);line-height:1.5;
}
...
.sector-label{
  font-family:'Space Grotesk',sans-serif;
  font-size:0.85rem;font-weight:600;letter-spacing:.2em;text-transform:uppercase;
...
.m-content-inner{background:rgba(5,5,5,.5);backdrop-filter:blur(16px);border:1px solid rgba(74,199,255,0.08);border-radius:14px;padding:16px}
...
.m-env-tag-icon{font-size:0.8rem}
.m-env-tag-label{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,0.5)}

.m-app-pillars{display:flex;flex-direction:column;gap:6px;margin-top:8px;max-height:220px;overflow-y:auto}
.m-app-pillar{background:rgba(74,199,255,0.03);border:1px solid rgba(74,199,255,0.08);border-radius:8px;padding:10px 12px}
.m-app-pillar-header{display:flex;align-items:center;gap:6px;margin-bottom:4px}
.m-app-pillar-icon{font-size:0.9rem}
.m-app-pillar-title{font-family:'Space Grotesk',sans-serif;font-size:0.6rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#F5F7FA}
.m-app-pillar-body{font-family:'Inter',sans-serif;font-size:0.55rem;color:rgba(167,175,187,0.7);line-height:1.4;margin-bottom:6px}
.m-app-pillar-caps{display:flex;flex-wrap:wrap;gap:3px}
.m-app-pillar-cap{font-family:'Space Grotesk',sans-serif;font-size:0.42rem;font-weight:500;letter-spacing:.08em;text-transform:uppercase;color:rgba(74,199,255,0.45);background:rgba(74,199,255,0.04);border:1px solid rgba(74,199,255,0.06);border-radius:10px;padding:2px 6px}
...
.m-coverage-card{background:rgba(74,199,255,0.04);border:1px solid rgba(74,199,255,0.1);border-radius:8px;padding:10px 8px;text-align:center}
.m-coverage-val{font-family:'Space Mono',monospace;font-size:1rem;font-weight:700;color:#4AC7FF;margin-bottom:4px}
.m-coverage-desc{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.7);line-height:1.4}

.m-scenario-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:6px;margin-top:8px}
.m-scenario-tile{background:rgba(74,199,255,0.04);border:1px solid rgba(74,199,255,0.1);border-radius:8px;padding:10px 8px;text-align:center}
.m-scenario-icon{font-size:0.9rem;margin-bottom:4px}
.m-scenario-title{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#F5F7FA;margin-bottom:4px}
.m-scenario-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.7);line-height:1.4}

.m-sector-grid{display:flex;flex-wrap:wrap;gap:5px;margin-top:8px;justify-content:center}
.m-sector-label{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.14em;text-transform:uppercase;padding:6px 14px;border-radius:20px;border:1px solid rgba(74,199,255,0.1);background:rgba(74,199,255,0.04);color:rgba(255,255,255,0.4)}
                      ...
                      {(s.applications as AppPillar[]).map((a, ai) => (
                        <div key={ai} className="m-app-pillar">
                          <div className="m-app-pillar-header">
                            <span className="m-app-pillar-icon">{a.icon}</span>
                    ...
                    <div className="m-payload-grid">
                      {(s.payloads as PayloadItem[]).map((p, pi) => (
                        <div key={pi} className="m-payload-card">
                          <div className="m-payload-icon">{p.icon}</div>
              ...
              {(s.applications as AppPillar[]).map((a, ai) => (
                <div key={ai} className="app-pillar">
                  <div className="app-pillar-header">
                    <span className="app-pillar-icon">{a.icon}</span>
            ...
            <div className="payload-grid">
              {(s.payloads as PayloadItem[]).map((p, pi) => (
                <div key={pi} className="payload-card">
                  <div className="payload-icon">{p.icon}</div>
