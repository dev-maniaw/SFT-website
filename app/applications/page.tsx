...
const SECTIONS: {
    ...
    applications: [
      {
        ...
        heading: 'RAPID CONNECTIVITY RESTORATION',
        body: 'Deploy HAWKE in disaster zones to restore communication networks within hours.',
        capabilities: ['Emergency relay', 'Situational awareness', 'Real-time monitoring'],
        icon: 'alert',
      },
      {
        num: '02',
        title: 'DEFENCE & BORDER',
        heading: 'PERSISTENT AERIAL SURVEILLANCE',
        body: 'Continuous monitoring and secure communication across challenging terrains.',
        capabilities: ['24/7 monitoring', 'Threat detection', 'Secure relay'],
        icon: 'shield',
      },
      {
        num: '03',
        title: 'TELECOM & CONNECTIVITY',
        heading: 'AERIAL NETWORK COVERAGE',
        body: 'Extend network reach to remote and underserved regions from elevated positions.',
        capabilities: ['Rural connectivity', 'Temporary networks', 'Event coverage'],
        icon: 'antenna',
      },
      {
        num: '04',
        title: 'INDUSTRIAL & ENVIRONMENTAL',
        heading: 'SITE MONITORING FROM ABOVE',
        body: 'Continuous oversight across mining, energy, and environmental operations.',
        capabilities: ['Asset surveillance', 'Thermal analysis', 'Environmental tracking'],
        icon: 'leaf',
      },
    ],
  },
  {
    ...
    pos: 'center' as const,
    bgPos: 'center center',
    img: '/sft/Application/Payload and sensor system.png',
  ...
  },
  {
    ...
    pos: 'center' as const,
    bgPos: 'center center',
    img: '/sft/Application/Cross industries values.png',
    overlay: 'radial-gradient(ellipse at center, rgba(5,5,5,0.88) 0%, rgba(5,5,5,0.72) 40%, rgba(5,5,5,0.4) 65%, rgba(5,5,5,0.2) 100%)',
...
/* ── Scroll driver ── */
#sd{height:1100vh;position:relative;z-index:5;pointer-events:none}
