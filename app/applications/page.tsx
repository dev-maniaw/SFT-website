...
.payload-desc{
  font-family:'Inter',sans-serif;
  font-size:0.78rem;color:rgba(167,175,187,0.88);line-height:1.5;
}
...
.coverage-desc{
  font-family:'Inter',sans-serif;
  font-size:0.85rem;color:rgba(167,175,187,0.88);line-height:1.5;
}
...
.o-footer-info{
  font-family:'Inter',sans-serif;
  font-size:0.9rem;color:rgba(167,175,187,0.92);text-align:center;line-height:1.6;
}
.o-footer-tagline{
  font-family:'Space Grotesk',sans-serif;
...
.m-env-tag-label{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,0.7)}
...
.m-app-pillar-body{font-family:'Inter',sans-serif;font-size:0.55rem;color:rgba(167,175,187,0.88);line-height:1.4;margin-bottom:6px}
.m-app-pillar-caps{display:flex;flex-wrap:wrap;gap:3px}
.m-app-pillar-cap{font-family:'Space Grotesk',sans-serif;font-size:0.42rem;font-weight:500;letter-spacing:.08em;text-transform:uppercase;color:rgba(74,199,255,0.7);background:rgba(74,199,255,0.04);border:1px solid rgba(74,199,255,0.06);border-radius:10px;padding:2px 6px}
...
.m-coverage-desc{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.88);line-height:1.4}
...
.m-scenario-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.88);line-height:1.4}
