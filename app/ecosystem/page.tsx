...
.p-num{font-family:'Space Mono',monospace;font-size:0.7rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.35);margin-bottom:6px}
...
.p-note{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:400;color:rgba(74,199,255,0.85);letter-spacing:.08em;padding-top:10px;border-top:1px solid rgba(74,199,255,0.12);max-width:380px;line-height:1.5;white-space:pre-line}
...
.node-pill{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:.18em;text-transform:uppercase;padding:10px 22px;border-radius:50px;border:1px solid rgba(74,199,255,0.15);background:rgba(74,199,255,0.04);color:rgba(74,199,255,0.85);backdrop-filter:blur(8px);opacity:0;transform:scale(0.9);transition:opacity 0.6s cubic-bezier(.16,1,.3,1), transform 0.6s cubic-bezier(.16,1,.3,1), background 0.3s ease, border-color 0.3s ease;position:relative}
...
.platform-spec{font-family:'Space Grotesk',sans-serif;font-size:0.6rem;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:rgba(74,199,255,0.75);background:rgba(74,199,255,0.05);border:1px solid rgba(74,199,255,0.08);border-radius:14px;padding:4px 10px}
...
.m-sec-num{font-family:'Space Mono',monospace;font-size:0.5rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.35);margin-bottom:4px}
...
.m-sec-note{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:400;color:rgba(74,199,255,0.75);letter-spacing:.08em;padding-top:6px;border-top:1px solid rgba(74,199,255,0.1);line-height:1.5}
...
.m-node-pill{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;padding:5px 12px;border-radius:14px;border:1px solid rgba(74,199,255,0.12);background:rgba(74,199,255,0.04);color:rgba(74,199,255,0.75)}
...
.m-layer-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.92);line-height:1.3}
...
.m-platform-body{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.88);line-height:1.5;margin-bottom:6px}
...
.m-payload-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.88);line-height:1.4}

.m-func-list{display:flex;flex-direction:column;gap:4px;margin-top:8px}
.m-func-item{font-family:'Space Grotesk',sans-serif;font-size:0.6rem;font-weight:400;color:rgba(255,255,255,0.7);letter-spacing:.04em;padding:6px 0;border-bottom:1px solid rgba(74,199,255,0.06);display:flex;align-items:flex-start;gap:6px;line-height:1.4}
...
.m-wf-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.92);line-height:1.3}
...
.m-comp-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.88);line-height:1.4}
...
.m-scale-desc{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.88);line-height:1.4}
