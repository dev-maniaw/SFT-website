...
.s-sec-num{font-family:'Space Mono',monospace;font-size:0.8rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.25)}
.s-sec-label{font-family:'Space Grotesk',sans-serif;font-size:0.8rem;font-weight:500;letter-spacing:.28em;text-transform:uppercase;color:rgba(74,199,255,0.55);transition:opacity .4s}
.s-sep{width:1px;height:12px;background:rgba(255,255,255,0.08)}
.s-nav-right{display:flex;align-items:center;gap:18px}
.s-nav-link{font-family:'Space Grotesk',sans-serif;font-size:0.75rem;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,0.3);text-decoration:none;transition:color .2s}
...
.p-eyebrow{font-family:'Space Grotesk',sans-serif;font-size:0.7rem;font-weight:500;letter-spacing:.28em;text-transform:uppercase;color:#4AC7FF;margin-bottom:12px;display:flex;align-items:center;gap:10px}
...
.p-num{font-family:'Space Mono',monospace;font-size:0.7rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.15);margin-bottom:6px}
.p-title{font-family:'Space Grotesk',sans-serif;font-size:clamp(2rem,3.5vw,3.5rem);font-weight:300;line-height:1.08;letter-spacing:-0.03em;color:#F5F7FA;white-space:pre-line;margin-bottom:14px;text-transform:uppercase;text-shadow:0 4px 32px rgba(0,0,0,0.6)}
.p-body{font-family:'Inter',sans-serif;font-size:0.82rem;color:#A7AFBB;line-height:1.72;max-width:380px;font-weight:400;margin-bottom:12px;white-space:pre-line}
.pos-right .p-body,.pos-right .p-note{margin-left:auto}
.pos-center .p-body{max-width:500px}
.p-note{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:400;color:rgba(74,199,255,0.6);letter-spacing:.08em;padding-top:10px;border-top:1px solid rgba(74,199,255,0.12);max-width:380px;line-height:1.5;white-space:pre-line}
...
.node-pill{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:.18em;text-transform:uppercase;padding:10px 22px;border-radius:50px;border:1px solid rgba(74,199,255,0.15);background:rgba(74,199,255,0.04);color:rgba(74,199,255,0.6);backdrop-filter:blur(8px);opacity:0;transform:scale(0.9);transition:opacity 0.6s cubic-bezier(.16,1,.3,1), transform 0.6s cubic-bezier(.16,1,.3,1), background 0.3s ease, border-color 0.3s ease;position:relative}
...
.layer-level{font-family:'Space Mono',monospace;font-size:0.65rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.2);flex-shrink:0;width:30px}
...
.layer-desc{font-family:'Inter',sans-serif;font-size:0.78rem;color:rgba(167,175,187,0.7);line-height:1.5}
...
.platform-alt{font-family:'Space Mono',monospace;font-size:0.6rem;font-weight:400;letter-spacing:.12em;color:rgba(255,255,255,0.2);margin-bottom:6px;margin-top:6px}
...
.platform-sub{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:500;letter-spacing:.14em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin-bottom:12px}
...
.platform-spec{font-family:'Space Grotesk',sans-serif;font-size:0.6rem;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:rgba(74,199,255,0.5);background:rgba(74,199,255,0.05);border:1px solid rgba(74,199,255,0.08);border-radius:14px;padding:4px 10px}
.platform-link{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:.16em;text-transform:uppercase;color:#4AC7FF;text-decoration:none;display:inline-flex;align-items:center;gap:6px;pointer-events:auto;transition:opacity .2s}
...
.payload-title{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:.14em;text-transform:uppercase;color:#4AC7FF;margin-bottom:8px}
.payload-desc{font-family:'Inter',sans-serif;font-size:0.78rem;color:rgba(167,175,187,0.7);line-height:1.5}

/* ── Functions list ── */
.func-list{display:flex;flex-direction:column;gap:10px;margin-top:16px}
.func-item{font-family:'Space Grotesk',sans-serif;font-size:0.82rem;font-weight:400;color:rgba(255,255,255,0.5);letter-spacing:.06em;padding:12px 0;border-bottom:1px solid rgba(74,199,255,0.08);display:flex;align-items:flex-start;gap:10px;line-height:1.5}
...
.wf-num{font-family:'Space Mono',monospace;font-size:0.6rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.2);margin-bottom:4px}
...
.wf-desc{font-family:'Inter',sans-serif;font-size:0.72rem;color:rgba(167,175,187,0.65);line-height:1.5}
...
.scale-desc{font-family:'Inter',sans-serif;font-size:0.85rem;color:rgba(167,175,187,0.7);line-height:1.5}
...
.i-sub{font-family:'Inter',sans-serif;font-size:0.95rem;color:#A7AFBB;line-height:1.82;max-width:520px;margin-bottom:42px;text-align:center}
...
.o-eyebrow{font-family:'Space Grotesk',sans-serif;font-size:0.85rem;font-weight:500;letter-spacing:.28em;text-transform:uppercase;color:rgba(74,199,255,0.45);display:flex;align-items:center;gap:12px;margin-bottom:16px}
...
.o-footer-link{font-family:'Space Grotesk',sans-serif;font-size:0.85rem;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,0.2);text-decoration:none;transition:color .2s}
.o-footer-link:hover{color:rgba(74,199,255,0.6)}
.o-footer-info{font-family:'Inter',sans-serif;font-size:0.9rem;color:rgba(167,175,187,0.6);text-align:center;line-height:1.6}
...
.m-header-cta{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;background:transparent;color:#4AC7FF;border:1px solid rgba(74,199,255,0.4);padding:7px 12px;border-radius:50px;text-decoration:none}
...
.m-sec-num{font-family:'Space Mono',monospace;font-size:0.5rem;font-weight:400;letter-spacing:.1em;color:rgba(255,255,255,0.18);margin-bottom:4px}
.m-sec-label{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:500;letter-spacing:.24em;text-transform:uppercase;color:#4AC7FF;margin-bottom:8px;display:flex;align-items:center;gap:8px}
...
.m-sec-note{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:400;color:rgba(74,199,255,0.5);letter-spacing:.08em;padding-top:6px;border-top:1px solid rgba(74,199,255,0.1);line-height:1.5}
...
.m-node-pill{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;padding:5px 12px;border-radius:14px;border:1px solid rgba(74,199,255,0.12);background:rgba(74,199,255,0.04);color:rgba(74,199,255,0.5)}
...
.m-layer-name{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#F5F7FA}
.m-layer-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.6);line-height:1.3}
...
.m-platform-sub{font-family:'Space Grotesk',sans-serif;font-size:0.5rem;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin-bottom:6px}
.m-platform-body{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.7);line-height:1.5;margin-bottom:6px}
.m-platform-specs{display:flex;flex-wrap:wrap;gap:3px}
.m-platform-spec{font-family:'Space Grotesk',sans-serif;font-size:0.42rem;font-weight:500;letter-spacing:.08em;text-transform:uppercase;color:rgba(74,199,255,0.45);background:rgba(74,199,255,0.04);border:1px solid rgba(74,199,255,0.06);border-radius:10px;padding:2px 6px}
...
.m-payload-title{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#4AC7FF;margin-bottom:4px}
.m-payload-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.7);line-height:1.4}

.m-func-list{display:flex;flex-direction:column;gap:4px;margin-top:8px}
.m-func-item{font-family:'Space Grotesk',sans-serif;font-size:0.6rem;font-weight:400;color:rgba(255,255,255,0.5);letter-spacing:.04em;padding:6px 0;border-bottom:1px solid rgba(74,199,255,0.06);display:flex;align-items:flex-start;gap:6px;line-height:1.4}
...
.m-wf-num{font-family:'Space Mono',monospace;font-size:0.5rem;font-weight:400;color:rgba(255,255,255,0.2);flex-shrink:0;width:18px}
.m-wf-title{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#F5F7FA}
.m-wf-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.6);line-height:1.3}
...
.m-comp-title{font-family:'Space Grotesk',sans-serif;font-size:0.55rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:#F5F7FA;margin-bottom:4px}
.m-comp-desc{font-family:'Inter',sans-serif;font-size:0.5rem;color:rgba(167,175,187,0.7);line-height:1.4}
...
.m-scale-desc{font-family:'Inter',sans-serif;font-size:0.6rem;color:rgba(167,175,187,0.7);line-height:1.4}
...
.m-outro-footer{margin-top:auto;font-family:'Inter',sans-serif;font-size:0.7rem;color:rgba(167,175,187,0.5);text-align:center;line-height:1.6;letter-spacing:.04em}
.m-outro-footer-tag{font-family:'Space Grotesk',sans-serif;font-size:0.42rem;font-weight:500;letter-spacing:.16em;text-transform:uppercase;color:rgba(74,199,255,0.2);margin-top:8px}
`
