...
const SECTIONS = [
  {
    ...
    pos: 'left' as const,
    bgPos: 'right center',
    img: '/sft/SFT HOME/Home Hero - Why it matters.png',
  ...
  },
  {
    ...
    pos: 'center' as const,
    bgPos: 'center center',
    img: '/sft/SFT HOME/Deployable  aerial platfom.png',
  ...
  },
  {
    ...
    pos: 'left' as const,
    bgPos: 'right center',
    img: '/sft/SFT HOME/High Altitude Platform system.png',
    overlay: 'linear-gradient(90deg, rgba(5,5,5,0.94) 0%, rgba(5,5,5,0.82) 38%, rgba(5,5,5,0.3) 65%, transparent 100%)',
  ...
  },
  {
    ...
    pos: 'right' as const,
    bgPos: 'left center',
    img: '/sft/SFT HOME/Modular Mission System.png',
    overlay: 'linear-gradient(270deg, rgba(5,5,5,0.94) 0%, rgba(5,5,5,0.82) 38%, rgba(5,5,5,0.3) 65%, transparent 100%)',
...
.upd-card-desc{
  font-family:'Inter',sans-serif;
  font-size:0.95rem;color:rgba(167,175,187,0.88);line-height:1.6;
}
